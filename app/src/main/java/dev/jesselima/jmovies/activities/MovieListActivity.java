...
import dev.jesselima.jmovies.adapters.MovieListAdapter;
import dev.jesselima.jmovies.config.ApiConfig;
import dev.jesselima.jmovies.config.ApiConfig.UrlParamKey;
import dev.jesselima.jmovies.config.ApiConfig.UrlParamValue;
import dev.jesselima.jmovies.databinding.ActivityMovieListBinding;
import dev.jesselima.jmovies.loaders.MovieListLoader;
import dev.jesselima.jmovies.models.Movie;
import dev.jesselima.jmovies.utils.AdaptiveGridLayout;
import dev.jesselima.jmovies.utils.BottomNavigationBehavior;
import dev.jesselima.jmovies.utils.BottomNavigationViewHelper;
...
public class MovieListActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<List<Movie>>, SharedPreferences.OnSharedPreferenceChangeListener {
