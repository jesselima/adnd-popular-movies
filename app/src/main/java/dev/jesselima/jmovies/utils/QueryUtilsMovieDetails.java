...
public final class QueryUtilsMovieDetails {
     ...
     *
     * @param requestUrl is the URL request to the API. This requestUrl (in this case) will come from inside of onCreateLoader method in {@link dev.jesselima.jmovies.activities.MovieDetailsActivity}
