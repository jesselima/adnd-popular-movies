...
public class Player3Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.button_back_to_movie_videos).setOnTouchListener(mDelayHideTouchListener);
        ...
        buttonBackToVideosList.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                finish();
            }
